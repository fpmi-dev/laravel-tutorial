...
<head>
	...
	<!-- Magnific Popup -->
    <link rel="stylesheet" href="{{ url('/magnific-popup.min.css') }}">
	<!-- Font Awesome -->
    <link rel="stylesheet" href="{{ url('/font-awesome.css') }}">
	<!-- Fancybox -->
	<link rel="stylesheet" href="{{ url('/jquery.fancybox.min.css') }}">
	<!-- Themify Icons -->
    <link rel="stylesheet" href="{{ url('/themify-icons.css') }}">
	<!-- Nice Select CSS -->
    <link rel="stylesheet" href="{{ url('/niceselect.css') }}">
	<!-- Animate CSS -->
    <link rel="stylesheet" href="{{ url('/animate.css') }}">
	<!-- Flex Slider CSS -->
    <link rel="stylesheet" href="{{ url('/flex-slider.min.css') }}">
	<!-- Owl Carousel -->
    <link rel="stylesheet" href="{{ url('/owl-carousel.css') }}">
	<!-- Slicknav -->
    <link rel="stylesheet" href="{{ url('/slicknav.min.css') }}">
